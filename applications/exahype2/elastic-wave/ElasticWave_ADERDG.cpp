...
#include "ElasticWave_ADERDG.h"

tarch::logging::Log applications::exahype2::elasticwave::ElasticWave_ADERDG::_log("applications::exahype2::elasticwave::ElasticWave_ADERDG");

void applications::exahype2::elasticwave::ElasticWave_ADERDG::initialCondition(
...
void applications::exahype2::elasticwave::ElasticWave_ADERDG::boundaryConditions(
...
::exahype2::RefinementCommand applications::exahype2::elasticwave::ElasticWave_ADERDG::refinementCriterion(
