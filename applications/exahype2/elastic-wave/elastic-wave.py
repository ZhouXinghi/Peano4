...
parser = argparse.ArgumentParser(
    description="ExaHyPE 2 - Elastic Wave Application Script"
)
...
my_project = exahype2.Project(
    ...
    project_name="ElasticWave" + args.scenario,
    directory=".",
    executable=executable_name,
)

if args.solver in aderdg_rusanov_solvers:
    solver_name = "ElasticWave_ADERDG"
elif args.solver in rkdg_rusanov_solvers:
    solver_name = "ElasticWave_RKDG"
elif args.solver in fv_rusanov_solvers:
    solver_name = "ElasticWave_FV"

unknowns = {"v": args.dim, "sigma": 3}
...
my_solver.set_implementation(
    ...
    flux="::applications::exahype2::elasticwave::flux(Q, normal, F);",
    eigenvalues="return ::applications::exahype2::elasticwave::maxEigenvalue();",
    refinement_criterion=exahype2.solvers.PDETerms.User_Defined_Implementation,
    source_term="::applications::exahype2::elasticwave::sourceTerm(Q, volumeCentre, t, S);",
    ncp=exahype2.solvers.PDETerms.None_Implementation,
)

my_solver.plot_description = "u, v, sxx, syy, sxy"

my_solver.add_user_solver_includes(
    """
#include "ElasticWaveKernels.h"
"""
)
...
my_project.set_global_simulation_parameters(
    dimensions=args.dim,
    size=[20.0, 20.0, 20.0][0 : args.dim],
    offset=[-5.0, 0.0, 0.0][0 : args.dim],
...
my_project.constants.define_value("RHO", str(rho))
my_project.constants.define_value("P_WAVE_SPEED", str(p_wave_speed))
my_project.constants.define_value("S_WAVE_SPEED", str(s_wave_speed))
...
print("Regenerate all code by running 'python3 elastic-wave.py' again")
print(
    "Generate (and convert) any postprocessing data by calling 'python3 elastic-wave.py --visualise'"
)
