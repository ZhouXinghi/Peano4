  ...
  public:
    ...
    public:
        ...
        */
        ...
        /**
        * Only exists for the generated kernels, should never be called
        */
        void mapDiscreteMaximumPrincipleObservables(double* const observables, const double* const Q) const {
          ::exahype2::triggerNonCriticalAssertion( __FILE__, __LINE__, "map discrete maximum principle observables was called, it should never be.", "" );
        }
        ...
        */
        double getDiscreteMaximumPrincipleRelaxationParameter(
          ...
          const double& previousMax) const {
            ::exahype2::triggerNonCriticalAssertion( __FILE__, __LINE__, "get discrete maximum principle relaxation parameter was called, it should never be.", "" );
            return 0.0;
        }
