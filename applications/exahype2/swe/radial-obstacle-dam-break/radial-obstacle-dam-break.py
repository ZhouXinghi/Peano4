...
"""
    ...
    my_project.constants.export_constexpr_with_type("DAM_RADIUS", str(1.0), "double")
    my_project.constants.export_constexpr_with_type(
        "INITIAL_WATER_HEIGHT_INSIDE_DAM", str(1.1), "double"
    )
    my_project.constants.export_constexpr_with_type(
        "INITIAL_WATER_HEIGHT_OUTSIDE_DAM", str(1.0), "double"
    )
    my_project.constants.export_constexpr_with_type(
        "BATHYMETRY_INSIDE_OBSTACLE", str(2.0), "double"
    )
    my_project.constants.export_constexpr_with_type(
        "BATHYMETRY_OUTSIDE_OBSTACLE", str(-1.0), "double"
    )
