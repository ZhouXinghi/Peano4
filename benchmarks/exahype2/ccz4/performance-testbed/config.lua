...
run_command    = "<executable> --timeout 3600"
...
profile_start = {
   unit = "s",      -- 'p' for 'percentage'
   value = 100,         -- delay in percentage of the total application time
}
