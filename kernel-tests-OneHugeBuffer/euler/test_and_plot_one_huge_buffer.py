...
def plot_results(results, ps_values, d_value):
    ...
    for ps_value, result_set in zip(ps_values, results):
        ...
        plt.plot(patches, gpu_onehugebuffer_times, label='GPU OneHugeBuffer', marker='o')
        plt.plot(patches, gpu_onehugebuffer_packed_times, label='GPU OneHugeBuffer Packed', marker='o')
...
def main():
    ...
    for d_value in d_values:
        ...
        plot_results(all_results, ps_values, d_value)
