...
class AdaptivityCriterion(AbstractRungeKuttaDGActionSet):
  """
  ...
  if ( 
    ...
    if (
      refinementCriterion==::exahype2::RefinementCommand::Refine 
      and 
      tarch::la::smaller( tarch::la::max( marker.h() ), repositories::{{SOLVER_INSTANCE}}.MinAdmissibleCellH )
    ) {
...
"""
  ...
  def event_lifetime(self,value):
    ...
    """
    self._event_lifetime = value * self._solver._rk_order
