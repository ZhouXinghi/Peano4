...
class EmptyPostprocessSolution(AbstractRungeKuttaDGActionSet):
    """
...
class DoFWisePostprocessSolution(AbstractRungeKuttaDGActionSet):
    """
...
class CellWisePostprocessSolution(AbstractRungeKuttaDGActionSet):
    """ """
