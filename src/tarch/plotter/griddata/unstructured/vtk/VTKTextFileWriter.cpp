...
tarch::logging::Log tarch::plotter::griddata::unstructured::vtk::VTKTextFileWriter::_log("tarch::plotter::griddata::"
                                                                                         "unstructured::vtk::"
                                                                                         "VTKTextFileWriter");
...
bool tarch::plotter::griddata::unstructured::vtk::VTKTextFileWriter::writeToFile() {
  ...
  if ((!out.fail()) && out.is_open()) {
    ...
    out << "CELLS " << _numberOfCells << " " << _numberOfCellEntries << std::endl << std::endl;
...
bool tarch::plotter::griddata::unstructured::vtk::VTKTextFileWriter::isOpen() { return !_writtenToFile; }

tarch::plotter::griddata::unstructured::UnstructuredGridWriter::VertexWriter* tarch::plotter::griddata::unstructured::
  vtk::VTKTextFileWriter::createVertexWriter() {
...
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::CellWriter* tarch::plotter::griddata::unstructured::
  vtk::VTKTextFileWriter::createCellWriter() {
  return new tarch::plotter::griddata::unstructured::vtk::VTKTextFileWriter::CellWriter(*this);
}

void tarch::plotter::griddata::unstructured::vtk::VTKTextFileWriter::validateDataWriterIdentifier(
...
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::CellDataWriter* tarch::plotter::griddata::unstructured::
  vtk::VTKTextFileWriter::createCellDataWriter(const std::string& identifier, int recordsPerCell) {
  validateDataWriterIdentifier(identifier);
  return new tarch::plotter::griddata::unstructured::vtk::VTKTextFileWriter::CellDataWriter(
...
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::VertexDataWriter* tarch::plotter::griddata::
  unstructured::vtk::VTKTextFileWriter::createVertexDataWriter(const std::string& identifier, int recordsPerVertex) {
  validateDataWriterIdentifier(identifier);
  return new tarch::plotter::griddata::unstructured::vtk::VTKTextFileWriter::VertexDataWriter(
