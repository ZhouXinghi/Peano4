...
parser = argparse.ArgumentParser(description="SPH testing script")
parser.add_argument(
...
project_namespace = ["tests", "swift2", "sedov"]

project = swift2.Project(
    namespace=project_namespace, project_name="sedov", executable="sedov1D"
)
...
dimensions = args.dimensions  # Peano dimensions
...
# project.algorithm_step_initial_conditions.add_action_set( swift2.input.InsertParticlesFromHDF5File(
#  particle_set= particle_set,
#  filename='sedov.hdf5'
#  ))


# Alternative method: InsertParticlesByCoordinates
...
ICs = swift2.scenario.SedovBlastIC()
...
project.algorithm_step_initial_conditions.add_action_set(
    swift2.input.InsertParticlesByCoordinates(
        ...
        coordinates=coords,
        additional_includes="""
#include "swift2/legacy/equation_of_state.h"
""",
    )
)
...
particle_plotter.add_attribute_to_plot(particle.f, 1)
