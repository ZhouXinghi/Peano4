...
namespace tutorials {namespace exahype2 {namespace advection {
  class AbstractAdvection;

}}}

class tutorials::exahype2::advection::AbstractAdvection: public ::exahype2::Solver {
  public:
    ...
    static constexpr int  NumberOfFiniteVolumesPerAxisPerPatch = 16;
     ...
     */
    static constexpr double MaxAdmissiblePatchH  = 0.1 * NumberOfFiniteVolumesPerAxisPerPatch;
    static constexpr double MaxAdmissibleVolumeH = 0.1;
     ...
     * coarser MinH.
     */
    static constexpr double MinAdmissiblePatchH  = 0.1 * NumberOfFiniteVolumesPerAxisPerPatch;
    static constexpr double MinAdmissibleVolumeH = 0.1;
    ...
    static constexpr int    NumberOfUnknowns           = 2;
